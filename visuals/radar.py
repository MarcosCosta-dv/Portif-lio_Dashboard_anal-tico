...
def radar_plotly(
    ...
    if tema == "dark":
        paper_bg = plot_bg = "#0e1117"; grid="rgba(255,255,255,0.10)"
        font = "#e5e5e5"; line_c="#4cc9f0"; fill_c="rgba(76,201,240,0.25)"
        base_fill="rgba(200,200,200,0.12)"; base_line="rgba(160,160,160,0.6)"
    else:
        paper_bg = plot_bg = "#ffffff"; grid="rgba(0,0,0,0.12)"
        font = "#222"; line_c="#2563eb"; fill_c="rgba(37,99,235,0.20)"
        base_fill="rgba(0,0,0,0.06)"; base_line="rgba(120,120,120,0.7)"
    ...
    fig.update_layout(
        ...
        font=dict(color=font, size=13), showlegend=False,
